...
export default function Checkout() {
    return (<section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        ...
        <span
          ...
          <svg className="me-2 size-4 sm:size-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <span
          ...
          Checkout
                    ...
                    <li className="flex shrink-0 items-center">
                        <svg className="me-2 size-4 sm:size-5" aria-hidden="true"
                ...
                <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                    <div className="min-w-0 flex-1 space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center">
                                        <button id="dropdown-phone-button-3" data-dropdown-toggle="dropdown-phone-3"
                                                ...
                                                type="button">
                                            <svg fill="none" aria-hidden="true" className="me-2 size-4"
                                                 viewBox="0 0 20 15">
                                                <rect width="19.6" height="14" y=".5" fill="#fff" rx="2"/>
                                                <mask id="a" style={{maskType: "luminance"}} width="20" height="15"
                                                      x="0"
                                                      y="0" maskUnits="userSpaceOnUse">
                                                    <rect width="19.6" height="14" y=".5" fill="#fff" rx="2"/>
                                                </mask>
                                                <g mask="url(#a)">
                                                    <path fill="#D02F44" fillRule="evenodd"
                                                ...
                                                <defs>
                                                    ...
                                                    <filter id="filter0_d_343_121520" width="6.533" height="5.667"
                                                            x=".933" y="1.433" colorInterpolationFilters="sRGB"
                                            ...
                                            +1
                                            <svg className="-me-0.5 ms-2 size-4" aria-hidden="true"
                        ...
                        <span className="inline-flex items-center">
                          <svg fill="none" aria-hidden="true" className="me-2 size-4" viewBox="0 0 20 15">
                            <rect width="19.6" height="14" y=".5" fill="#fff" rx="2"/>
                            <mask id="a" style={{maskType: "luminance"}} width="20" height="15" x="0" y="0"
                        ...
                        <span className="inline-flex items-center">
                          <svg className="me-2 size-4" fill="none" viewBox="0 0 20 15">
                            ...
                            <g mask="url(#a)">
                              ...
                              <path fill="#E6273E" fillRule="evenodd"
                                    d="M0 8.9h8.4v5.6h2.8V8.9h8.4V6.1h-8.4V.5H8.4v5.6H0v2.8z" clipRule="evenodd"/>
                            </g>
                          </svg>
                          United Kingdom (+44)
                        </span>
                        ...
                        <span className="inline-flex items-center">
                          <svg className="me-2 size-4" fill="none" viewBox="0 0 20 15"
                            ...
                            <g mask="url(#a)">
                              ...
                              <path fill="url(#paint0_linear_374_135177)" fillRule="evenodd"
                                    ...
                                    clipRule="evenodd"/>
                              <path fill="url(#paint1_linear_374_135177)" fillRule="evenodd"
                        ...
                        <span className="inline-flex items-center">
                          <svg className="me-2 size-4" fill="none" viewBox="0 0 20 15">
                            ...
                            <g mask="url(#a)">
                              <path fill="#262626" fillRule="evenodd" d="M0 5.167h19.6V.5H0v4.667z"
                                    clipRule="evenodd"/>
                              <g filter="url(#filter0_d_374_135180)">
                                <path fill="#F01515" fillRule="evenodd" d="M0 9.833h19.6V5.167H0v4.666z"
                                      clipRule="evenodd"/>
                              </g>
                              <g filter="url(#filter1_d_374_135180)">
                                <path fill="#FFD521" fillRule="evenodd" d="M0 14.5h19.6V9.833H0V14.5z"
                                      clipRule="evenodd"/>
                              </g>
                            </g>
                            <defs>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <div
                                    ...
                                    <div className="flex items-start">
                                        <div className="flex h-5 items-center">
                                            <input id="credit-card" aria-describedby="credit-card-text" type="radio"
                                                   ...
                                                   className="size-4 border-gray-300 bg-white text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                                                   checked/>
                                        </div>
                                    ...
                                    <div className="mt-4 flex items-center gap-2">
                                        <button type="button"
                                                className="text-sm font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Delete
                                        </button>

                                        <div className="h-3 w-px shrink-0 bg-gray-200 dark:bg-gray-700"></div>

                                        <button type="button"
                                                className="text-sm font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Edit
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ms-4 text-sm">
                                            <label htmlFor="pay-on-delivery"
                                                   className="font-medium leading-none text-gray-900 dark:text-white"> Payment
                                                on delivery </label>
                                            <p id="pay-on-delivery-text"
                                               className="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">+$15
                                ...
                                <div
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ms-4 text-sm">
                                            <label htmlFor="paypal-2"
                                                   className="font-medium leading-none text-gray-900 dark:text-white"> Paypal
                                                account </label>
                                            <p id="paypal-text"
                                               className="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">Connect
                                                to your account</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ms-4 text-sm">
                                            <label htmlFor="express"
                                                   className="font-medium leading-none text-gray-900 dark:text-white"> $49
                    ...
                    <div className="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-sm font-normal text-gray-500 dark:text-gray-400">One or more items in
                                your cart require an account. <a href="#" title=""
                                                                 className="font-medium text-primary-700 underline hover:no-underline dark:text-primary-500">Sign
